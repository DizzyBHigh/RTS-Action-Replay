...
public class CPHInline
{
    ...
    private void Build(RtsUI ui)
    {
        ...
        ui.BeginRow(); ui.AddColorPicker("Title Colour", "Panel title text colour.", "Information Panels", StylePrefix + "header.titleColor", "#FFFFFFFF"); ui.AddGoogleFontSelector("Title Font", "Google Font used by the panel title.", "Information Panels", StylePrefix + "header.font", "Inter"); ui.EndRow();
        ui.BeginRow(); ui.AddNumericTextbox("Title Size", "Panel title font size in pixels.", "Information Panels", StylePrefix + "header.size", 24, 8, 72); ui.AddDropdown("Title Weight", "Panel title font weight.", "Information Panels", StylePrefix + "header.weight", new[] { "400", "500", "600", "700", "800", "900" }, "800"); ui.EndRow();
        ui.BeginRow(); ui.AddColorPicker("Title Shadow Colour", "Panel title shadow colour.", "Information Panels", StylePrefix + "header.shadowColor", "#000000FF"); ui.AddColorPicker("Primary Colour", "Header gradient primary colour.", "Information Panels", StylePrefix + "header.primary", "#0384CBFF"); ui.AddColorPicker("Secondary Colour", "Header gradient secondary colour.", "Information Panels", StylePrefix + "header.secondary", "#101416FF"); ui.EndRow();
