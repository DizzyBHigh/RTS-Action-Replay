...
public class CPHInline
{
    ...
    private object Parse(string field, string value) { if (field == "fontSize" || field == "Width" || field.Contains("Height") || field.Contains("Spacing") || field == "chevronSpeed" || field == "barHeight" || field == "delay" || field == "duration" || field == "animationDuration") { int n; return int.TryParse(value, out n) ? n : 0; } if (field.StartsWith("random", StringComparison.OrdinalIgnoreCase) || field == "showTitle") { bool b; return bool.TryParse(value, out b) && b; } return value; }
