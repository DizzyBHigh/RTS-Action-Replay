...
public class CPHInline
{
    ...
    private void ApplyPlayerSettings()
    {
        ...
        CPH.SetArgument("replayShowTitle", CPH.GetGlobalVar<bool?>("rts.actionreplay.showTitle", true) ?? true); CPH.SetArgument("replayShowBranding", CPH.GetGlobalVar<bool?>("rts.actionreplay.showBranding", true) ?? true); CPH.SetArgument("replayTitleStyle", CPH.GetGlobalVar<string>("rts.actionreplay.titleBarStyle", true) ?? "Broadcast"); CPH.SetArgument("replayTitlePosition", CPH.GetGlobalVar<string>("rts.actionreplay.titlePosition", true) ?? "Bottom");
        ...
        CPH.SetArgument("replayTitleGradientStart", CPH.GetGlobalVar<string>("rts.actionreplay.titleGradientStart", true) ?? "#FF05090C"); CPH.SetArgument("replayTitleGradientEnd", CPH.GetGlobalVar<string>("rts.actionreplay.titleGradientEnd", true) ?? "#FF16232B"); CPH.SetArgument("replayTitleBackgroundColor", CPH.GetGlobalVar<string>("rts.actionreplay.titleBackgroundColor", true) ?? "#FF05090C");
        CPH.SetArgument("replayTitleShapeGradientStart", CPH.GetGlobalVar<string>("rts.actionreplay.titleShapeGradientStart", true) ?? "#FF0384CB"); CPH.SetArgument("replayTitleShapeGradientEnd", CPH.GetGlobalVar<string>("rts.actionreplay.titleShapeGradientEnd", true) ?? "#FF7BD7FF");
    }
