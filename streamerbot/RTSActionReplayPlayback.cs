...
public class CPHInline
{
    ...
    private string GetKickPlaybackMode() { var mode = CPH.GetGlobalVar<string>(KickModeKey, true); if (string.Equals(mode, "Kick URL", StringComparison.OrdinalIgnoreCase)) return "Kick URL"; if (string.Equals(mode, "Both", StringComparison.OrdinalIgnoreCase)) return "Both"; return "Download Locally"; }
