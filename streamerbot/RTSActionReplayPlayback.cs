...
public class CPHInline
{
    ...
    private void ApplyPlayerSettings(string profile)
    {
        ...
        CPH.SetArgument("replayBroadcastPrimaryColor", CPH.GetGlobalVar<string>("rts.actionreplay.broadcast.primaryColor", true) ?? "#0384CBFF"); CPH.SetArgument("replayBroadcastSecondaryColor", CPH.GetGlobalVar<string>("rts.actionreplay.broadcast.secondaryColor", true) ?? "#FFD400FF"); CPH.SetArgument("replayBroadcastChevronHeight", GetSettingInt("rts.actionreplay.broadcast.chevronHeight", GetSettingInt("rts.actionreplay.broadcast.chevronWidth", 42))); CPH.SetArgument("replayBroadcastRandomHeight", CPH.GetGlobalVar<bool?>("rts.actionreplay.broadcast.randomHeight", true) ?? false); CPH.SetArgument("replayBroadcastChevronSpacing", GetSettingInt("rts.actionreplay.broadcast.chevronSpacing", 0)); CPH.SetArgument("replayBroadcastRandomSpacing", CPH.GetGlobalVar<bool?>("rts.actionreplay.broadcast.randomSpacing", true) ?? false); CPH.SetArgument("replayBroadcastChevronSpeed", GetSettingInt("rts.actionreplay.broadcast.chevronSpeed", 95)); CPH.SetArgument("replayBroadcastDecorationColor", CPH.GetGlobalVar<string>("rts.actionreplay.broadcast.decorationColor", true) ?? "#0384CBFF"); CPH.SetArgument("replayBroadcastTitleColor", CPH.GetGlobalVar<string>("rts.actionreplay.broadcast.titleColor", true) ?? "#FFFFFFFF");
        CPH.SetArgument("replayCutPrimaryColor", CPH.GetGlobalVar<string>("rts.actionreplay.cut.primaryColor", true) ?? "#0384CBFF"); CPH.SetArgument("replayCutSecondaryColor", CPH.GetGlobalVar<string>("rts.actionreplay.cut.secondaryColor", true) ?? "#FFD400FF"); CPH.SetArgument("replayCutBlockWidth", GetSettingInt("rts.actionreplay.cut.blockWidth", 170)); CPH.SetArgument("replayCutRandomWidth", CPH.GetGlobalVar<bool?>("rts.actionreplay.cut.randomWidth", true) ?? true); CPH.SetArgument("replayCutBarHeight", GetSettingInt("rts.actionreplay.cut.barHeight", 5)); CPH.SetArgument("replayCutDecorationColor", CPH.GetGlobalVar<string>("rts.actionreplay.cut.decorationColor", true) ?? "#0384CBFF"); CPH.SetArgument("replayCutTitleColor", CPH.GetGlobalVar<string>("rts.actionreplay.cut.titleColor", true) ?? "#FFFFFFFF");
    }
