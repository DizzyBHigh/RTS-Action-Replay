...
public class CPHInline
{
    ...
    private void ApplyPlayerSettings(string profile)
    {
        ...
        CPH.SetArgument("replayBroadcastPrimaryColor", CPH.GetGlobalVar<string>("rts.actionreplay.broadcast.primaryColor", true) ?? "#0384CBFF"); CPH.SetArgument("replayBroadcastSecondaryColor", CPH.GetGlobalVar<string>("rts.actionreplay.broadcast.secondaryColor", true) ?? "#FFD400FF"); CPH.SetArgument("replayBroadcastChevronWidth", GetSettingInt("rts.actionreplay.broadcast.chevronWidth", 42)); CPH.SetArgument("replayBroadcastRandomWidth", CPH.GetGlobalVar<bool?>("rts.actionreplay.broadcast.randomWidth", true) ?? false); CPH.SetArgument("replayBroadcastChevronSpacing", GetSettingInt("rts.actionreplay.broadcast.chevronSpacing", 13)); CPH.SetArgument("replayBroadcastRandomSpacing", CPH.GetGlobalVar<bool?>("rts.actionreplay.broadcast.randomSpacing", true) ?? false); CPH.SetArgument("replayBroadcastDecorationColor", CPH.GetGlobalVar<string>("rts.actionreplay.broadcast.decorationColor", true) ?? "#0384CBFF"); CPH.SetArgument("replayBroadcastTitleColor", CPH.GetGlobalVar<string>("rts.actionreplay.broadcast.titleColor", true) ?? "#FFFFFFFF");
