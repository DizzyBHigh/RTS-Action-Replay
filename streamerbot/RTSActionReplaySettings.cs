...
public class CPHInline
{
    public bool Execute()
    {
        ...
        ui.AddTextbox("Brand Logo URL", "HTTPS URL to the shared branding logo. Leave blank to use RTS text.", "General", "rts.actionreplay.brandLogoUrl", "", false);
        ...
        AddPositionSettings(ui, value => pendingPositions = value);
        AddMessages(ui);
    ...
    private void AddPlayerSettings(RtsUI ui)
    {
        ...
        ui.AddGoogleFontSelector("Title Font", "Font used by the replay title.", "Player", "rts.actionreplay.titleFont", "Inter");
    ...
    private void AddPositionSettings(RtsUI ui, Action<string> save)
    {
        ...
        ui.AddPositionEditor("Saved Positions", "Create and edit reusable player positions. Full Screen is built in and cannot be deleted.", "Positions", "rts.actionreplay.positions", "{\"Full Screen\":{\"name\":\"Full Screen\",\"scale\":100,\"x\":0,\"y\":0,\"rotateX\":0,\"rotateY\":0,\"rotateZ\":0}}", save, PreviewPosition);
