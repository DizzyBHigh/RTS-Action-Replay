...
public class CPHInline
{
    ...
    public bool EnsurePositions()
    {
        ...
        CPH.LogInfo("RTS Action Replay: unified position store initialized.");
        return true;
    }
    ...
    JObject DefaultPlayer()=>Position("Full Screen","full-screen",100);JObject DefaultPanel()=>Position("Centered","centered",100);JObject DefaultClapper()=>Position("Centered","centered",50);
