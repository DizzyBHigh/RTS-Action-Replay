...
public partial class CPHInline
{
    ...
    private JObject BuildOverlayCommand()
    {
        ...
        AddNumber(command, "replayPlaybackSpeed", "rts.actionreplay.playbackSpeed", 1.0); AddString(command, "replayPlaybackSpeedVisibility", "rts.actionreplay.playbackSpeedVisibility", "Only when greater or less than 1");
        AddString(command, "replayFrameColor", "rts.actionreplay.frameColor", "#0384CBFF"); AddBool(command, "replayBorderGlow", "rts.actionreplay.borderGlow", true); AddInt(command, "replayBorderWidth", "rts.actionreplay.borderWidth", 4); AddInt(command, "replayCornerRadius", "rts.actionreplay.cornerRadius", 0);
        AddBool(command, "replayShowBranding", "rts.actionreplay.showBranding", true); AddString(command, "replayBrandLogoUrl", "rts.actionreplay.brandLogoUrl", ""); AddString(command, "replayBrandFallbackText", "rts.actionreplay.brandFallbackText", "RTS"); AddString(command, "replayBrandFallbackTextColor", "rts.actionreplay.brandFallbackTextColor", "#0384CBFF"); AddString(command, "replayBrandLabel", "rts.actionreplay.brandLabel", "ACTION REPLAY"); AddString(command, "replayBrandLabelColor", "rts.actionreplay.brandLabelColor", "#FFFFFFFF");
        AddBool(command, "replayShowTitle", "rts.actionreplay.showTitle", true); AddString(command, "replayTitleDecorationPosition", "rts.actionreplay.titleDecorationPosition", "Suffix"); AddString(command, "replayTitleDecoration", "rts.actionreplay.titleDecoration", " - Replay Capture"); AddString(command, "replayTitleStyle", "rts.actionreplay.titleBarStyle", "Broadcast"); AddString(command, "replayTitlePosition", "rts.actionreplay.titlePosition", "Bottom"); AddString(command, "replayTitleAnimation", "rts.actionreplay.titleAnimation", "Slide up/down");
        AddInt(command, "replayTitleDelay", "rts.actionreplay.titleDelay", 0); AddInt(command, "replayTitleDuration", "rts.actionreplay.titleDuration", 5000); AddInt(command, "replayTitleAnimationDuration", "rts.actionreplay.titleAnimationDuration", 450); AddString(command, "replayTitleFont", "rts.actionreplay.titleFont", "Inter"); AddInt(command, "replayTitleFontSize", "rts.actionreplay.titleFontSize", 34); AddString(command, "replayTitleTextColor", "rts.actionreplay.titleTextColor", "#FFFFFFFF"); AddString(command, "replayTitleShadowColor", "rts.actionreplay.titleShadowColor", "#000000FF"); AddString(command, "replayTitlePrimaryColor", "rts.actionreplay.titlePrimaryColor", "#0384CBFF"); AddString(command, "replayTitleSecondaryColor", "rts.actionreplay.titleSecondaryColor", "#101416FF");
        AddBool(command, "replayBroadcastOverrideColours", "rts.actionreplay.broadcast.overrideColours", false); AddBool(command, "replayCutOverrideColours", "rts.actionreplay.cut.overrideColours", false);
