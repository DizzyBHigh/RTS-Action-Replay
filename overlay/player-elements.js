...
RTSReplayElements.configure = command => {
  ...
  const primary = RTSReplayElements.toCssHex(command.replayTitlePrimaryColor || '#0384CBFF');
  const secondary = RTSReplayElements.toCssHex(command.replayTitleSecondaryColor || '#101416FF');
